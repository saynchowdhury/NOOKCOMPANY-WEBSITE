  ...
  return (
    <section id="hero" className="relative w-full overflow-hidden" data-navbar-theme="dark">
      <div className="relative min-h-[100svh] w-full flex flex-col">
        ...
        {/* Bottom Landscape Image with Stretched NOOK COMPANY text */}
        <div className="relative z-10 w-full mt-auto">
          {/* Landscape image */}
          <div className="relative w-full h-[220px] sm:h-[280px] md:h-[340px] lg:h-[400px] overflow-hidden">
            {/* Gradient blend from hero into landscape */}
            ...
            <div className="absolute inset-0 z-20 flex items-end justify-center overflow-hidden">
              <div
                className={`w-full text-center pb-4 sm:pb-6 md:pb-8 transition-all duration-[1.5s] delay-700 ease-out ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
              >
                <h2
                  className="font-display font-bold text-white/90 leading-[0.85] tracking-[-0.04em] whitespace-nowrap mx-auto"
                  style={{
                    fontSize: 'clamp(60px, 14vw, 220px)',
                    transform: 'scaleX(1.35)',
                    textShadow: '0 2px 40px rgba(0,0,0,0.5), 0 0 120px rgba(0,0,0,0.3)',
                  }}
                >
                  NOOK COMPANY
                </h2>
